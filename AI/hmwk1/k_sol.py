...
def decode(solution):
	...
	#representations
	global max_range
	x = convertFromBits(solution[0:16],-max_range,max_range)
	y = convertFromBits(solution[16:32],-max_range,max_range)
	z = convertFromBits(solution[32:48],0,max_range)
...
if "plot" in sys.argv[1:]:
	search(100, evaluateSolutions, True)
else:
